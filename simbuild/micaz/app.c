...
#line 260
extern double erfc(double arg_0xb7b2a8c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79d4840), 
int (*key_eq_fn)(void *arg_0xb79d4c88, void *arg_0xb79d4e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78a39b8, int arg_0xb78a3b10);
static double RandomUniform(void );
...
typedef TMilli ProjectKYDC$MilliTimer$precision_tag;
...
static void ProjectKYDC$AMControl$startDone(error_t error);
#line 138
static void ProjectKYDC$AMControl$stopDone(error_t error);
# 60 "/opt/tinyos-main-2.1.2/tos/interfaces/Boot.nc"
static void ProjectKYDC$Boot$booted(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void ProjectKYDC$AMSend$sendDone(
#line 103
message_t * msg, 
...
static void ProjectKYDC$MilliTimer$fired(void );
...
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*ProjectKYDAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*ProjectKYDAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t ProjectKYDC$AMControl$start(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t ProjectKYDC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void ProjectKYDC$MilliTimer$startPeriodic(uint32_t dt);
# 22 "ProjectKYDC.nc"
uint8_t ProjectKYDC$rec_id[1000][20];
uint8_t ProjectKYDC$rec_counter[1000][20];
bool ProjectKYDC$locked[1000];


message_t ProjectKYDC$packet[1000];
uint8_t ProjectKYDC$index[1000];

static inline void ProjectKYDC$setIndex(uint8_t id);
...
static inline void ProjectKYDC$Boot$booted(void );





static inline void ProjectKYDC$AMControl$startDone(error_t err);
...
static inline void ProjectKYDC$AMControl$stopDone(error_t err);


static inline void ProjectKYDC$MilliTimer$fired(void );
#line 76
static void ProjectKYDC$AMSend$sendDone(message_t *buf, error_t err);
...
static inline message_t *ProjectKYDC$Receive$receive(message_t *buf, void *payload, uint8_t len);
# 53 "/opt/tinyos-main-2.1.2/tos/chips/atm128/timer/HplAtm128TimerCtrl8.nc"
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void /*ProjectKYDAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
static error_t /*ProjectKYDAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*ProjectKYDAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*ProjectKYDAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static inline error_t /*ProjectKYDAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*ProjectKYDAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
#line 32
  while (i < 20 && (ProjectKYDC$rec_id[sim_node()][i] != 0 && ProjectKYDC$rec_id[sim_node()][i] != id)) 
    i++;

  ProjectKYDC$index[sim_node()] = i;
}
...
#line 84
{
  if (len != sizeof(my_msg_t )) {
      sim_log_error(154U, "radio", "Packet received by %d malformed\n", TOS_NODE_ID);
      return buf;
    }
  else 
#line 88
    {
      ...
      ProjectKYDC$setIndex(__nesc_ntoh_uint8(mess->id.nxdata));

      if (ProjectKYDC$rec_id[sim_node()][ProjectKYDC$index[sim_node()]] == 0) {



          ProjectKYDC$rec_id[sim_node()][ProjectKYDC$index[sim_node()]] = __nesc_ntoh_uint8(mess->id.nxdata);
          ProjectKYDC$rec_counter[sim_node()][ProjectKYDC$index[sim_node()]] = 1;
          sim_log_debug(155U, "radio", "Received first packet from %d, counter %d\n", ProjectKYDC$rec_id[sim_node()][ProjectKYDC$index[sim_node()]], ProjectKYDC$rec_counter[sim_node()][ProjectKYDC$index[sim_node()]]);
        }
      else {

          if (ProjectKYDC$rec_counter[sim_node()][ProjectKYDC$index[sim_node()]] == 9) {
              ProjectKYDC$rec_counter[sim_node()][ProjectKYDC$index[sim_node()]]++;
              ...
              ProjectKYDC$rec_counter[sim_node()][ProjectKYDC$index[sim_node()]] = 0;
              sim_log_debug(156U, "radio", "Received last packet from %d. Motes %d and %d are too close\n", ProjectKYDC$rec_id[sim_node()][ProjectKYDC$index[sim_node()]], TOS_NODE_ID, ProjectKYDC$rec_id[sim_node()][ProjectKYDC$index[sim_node()]]);
            }
          else 
#line 114
            {
              ProjectKYDC$rec_counter[sim_node()][ProjectKYDC$index[sim_node()]]++;
              sim_log_debug(157U, "radio", "Received a packet from %d, counter %d\n", ProjectKYDC$rec_id[sim_node()][ProjectKYDC$index[sim_node()]], ProjectKYDC$rec_counter[sim_node()][ProjectKYDC$index[sim_node()]]);
            }
        }
...
#line 78
    case 20:
#line 78
      __nesc_result = ProjectKYDC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t ProjectKYDC$AMControl$start(void ){
#line 104
...
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void ProjectKYDC$MilliTimer$startPeriodic(uint32_t dt){
#line 64
...
{
  if (err == SUCCESS) {
      sim_log_debug(149U, "radio", "Timer started on mote %d\n", TOS_NODE_ID);
      ProjectKYDC$MilliTimer$startPeriodic(500);
    }
  else 
#line 49
    {
      sim_log_debug(150U, "radio", "Radio error, trying to turning on again...\n");
      ProjectKYDC$AMControl$start();
    }
}
...
#line 113
  ProjectKYDC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  ProjectKYDC$AMControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*ProjectKYDAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  ProjectKYDC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*ProjectKYDAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb73436a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb73436a8) {
#line 100
    case 0U:
#line 100
      /*ProjectKYDAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb73436a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb77ff650){
#line 75
  switch (arg_0xb77ff650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb77ff650);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb73420a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb73420a0, addr, msg, len);
#line 80
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*ProjectKYDAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static void /*ProjectKYDAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 103 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*ProjectKYDAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*ProjectKYDAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*ProjectKYDAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 20);
  return /*ProjectKYDAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}

# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t ProjectKYDC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*ProjectKYDAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 126 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
inline static void * ProjectKYDC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 58
{
  sim_log_debug(151U, "timer", "Timer fired on mote %d, send a request\n", TOS_NODE_ID);
  if (ProjectKYDC$locked[sim_node()]) {
      return;
    }
  else {
      __nesc_hton_uint8(((my_msg_t *)ProjectKYDC$Packet$getPayload(&ProjectKYDC$packet[sim_node()], sizeof(my_msg_t )))->id.nxdata, TOS_NODE_ID);

      if (ProjectKYDC$AMSend$send(AM_BROADCAST_ADDR, &ProjectKYDC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          ProjectKYDC$locked[sim_node()] = TRUE;
          sim_log_debug(152U, "radio", "Mote %d Request sent.\n", TOS_NODE_ID);
        }
    }
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb739a3a8){
#line 83
  switch (arg_0xb739a3a8) {
#line 83
    case 0U:
#line 83
      ProjectKYDC$MilliTimer$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb739a3a8);
#line 83
      break;
#line 83
    }
...
#line 76
{
  if (&ProjectKYDC$packet[sim_node()] == buf) {
      sim_log_debug(153U, "radio", "Packet sent at time %s from mote %d\n", sim_time_string(), TOS_NODE_ID);
      ProjectKYDC$locked[sim_node()] = FALSE;
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module ProjectKYDC */
  if (!strcmp(varname, "ProjectKYDC$rec_id"))
  {
    *addr = (uintptr_t)&ProjectKYDC$rec_id[__nesc_mote];
    *size = sizeof(ProjectKYDC$rec_id[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "ProjectKYDC$rec_counter"))
  {
    *addr = (uintptr_t)&ProjectKYDC$rec_counter[__nesc_mote];
    *size = sizeof(ProjectKYDC$rec_counter[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "ProjectKYDC$locked"))
  {
    *addr = (uintptr_t)&ProjectKYDC$locked[__nesc_mote];
    *size = sizeof(ProjectKYDC$locked[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "ProjectKYDC$packet"))
  {
    *addr = (uintptr_t)&ProjectKYDC$packet[__nesc_mote];
    *size = sizeof(ProjectKYDC$packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "ProjectKYDC$index"))
  {
    *addr = (uintptr_t)&ProjectKYDC$index[__nesc_mote];
    *size = sizeof(ProjectKYDC$index[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module ProjectKYDC */
  memset((void *)&ProjectKYDC$rec_id[__nesc_mote], 0, sizeof ProjectKYDC$rec_id[__nesc_mote]);
  memset((void *)&ProjectKYDC$rec_counter[__nesc_mote], 0, sizeof ProjectKYDC$rec_counter[__nesc_mote]);
  memset((void *)&ProjectKYDC$locked[__nesc_mote], 0, sizeof ProjectKYDC$locked[__nesc_mote]);
  memset((void *)&ProjectKYDC$packet[__nesc_mote], 0, sizeof ProjectKYDC$packet[__nesc_mote]);
  memset((void *)&ProjectKYDC$index[__nesc_mote], 0, sizeof ProjectKYDC$index[__nesc_mote]);
